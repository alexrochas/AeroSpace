...
== primary-secondary
----
include::aerospace-primary-secondary.adoc[tags=synopsis]
----
include::aerospace-primary-secondary.adoc[tags=purpose]
include::aerospace-primary-secondary.adoc[tags=body]
